...
-ระบบ login ด้วย Hotmail เพื่อให้คนสมัคร
-ในหน้าหลักมีเขียนถึง vision ของ alm impact tennis
-มี FAQ section
-มี Contact section

Flow
คนเปิดเว็บ > คนอยากจองสนาม > คนกดจอง > คนใช้อีเมล Hotmail สมัคร > ยืนยันเบอร์โทร OTP > กรอกระดับ NTRP ของตัวเองและกรอกว่าต้องการเจอผู้เล่น NTRP ระดับไหนบ้าง > workflow ไปสืบมาว่า ใครที่ตรงกับ requriement ของ users ก็ดึงมาให้มา Match กัน > หลัง match กันแล้ว ให้ผู้เล่นนัดวันและเวลามาเล่นกันได้ > มีการมาเจอกัน เล่นด้วยกัน > **คนสนุกชอบจะทำการรีวิว (UGC Content)**
