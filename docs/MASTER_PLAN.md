...
| 5 | **ถอดรหัส Mini-QR Code จากภาพสลิป** | ✅ | `services/qr_decoder.py` | ถอดรหัส Mini-QR payload จากสลิปโอนเงินโดยใช้ไลบรารี `pyzbar` และ `Pillow` เพื่อเตรียมส่งตรวจสอบ |
| 6 | **ระบบยืนยันสลิปผ่าน EasySlip API v2** | ✅ | `services/easyslip_service.py` | เชื่อมต่อกับ EasySlip API v2 (`/v2/verify/bank`) เพื่อดึงข้อมูลธนาคารจริงอย่างแม่นยำ 100% |
| 7 | **อนุมัติการจองอัตโนมัติ (Auto-Approve)** | ✅ | `routers/payments.py` | ยืนยันการจองสตรีมมิ่งทันที (`status = confirmed` และธุรกรรมเป็น `verified`) หากยอดเงินและวันเวลาผ่านเกณฑ์ตรวจสอบ โดยไม่ต้องรอแอดมิน |
| 8 | **สคริปต์ทดสอบสลิปจริง (CLI Tester)** | ✅ | `verify_real_slip.py` | ตัวช่วยการทดสอบด้วยสลิปจริง ป้อนไฟล์และจำนวนยอดเงินเพื่อเรียกใช้สแกนและดึงข้อมูล EasySlip จริง (ผ่านการทดสอบสดสำเร็จ) |
...
|---|--------|--------|------------|
| 1 | ระบบจองโค้ช (Coach Booking System) | ✅ | ค้นหา คัดกรอง และทำการจองคิวโค้ชผู้ฝึกสอนเทนนิสผ่านตารางออนไลน์พร้อมดักจับเวลาชนกัน (เสร็จสมบูรณ์ 100%) |
...
| 4 | ระบบรายงานกิจกรรมผู้ใช้ (User Activity Reports) | ❌ | (ชะลอการพัฒนา/ยกเลิกชั่วคราว ตามความเห็นร่วมกันกับลูกค้า เพื่อความผ่อนคลายของคอมมูนิตี้แบบสันทนาการ และย้ายลำดับความสำคัญไปที่ระบบคูปอง Voucher แทน) |
...
| # | รายการ | สถานะ | รายละเอียด |
|---|--------|--------|------------|
| 1 | ระบบขายสินค้า/บริการในสนาม (Storefront) | ✅ | สั่งซื้อน้ำดื่ม ลูกเทนนิส เช่าไม้เทนนิส พร้อมระบบตัดคลังสินค้าคงเหลือ (stock) อัตโนมัติ (เสร็จสมบูรณ์ 100%) |
| 2 | ระบบ Voucher Redeem | ✅ | ระบบสร้างคูปอง, ตรวจเช็คเงื่อนไขหมดอายุ/โควตาใช้งาน, ป้องกันใช้ซ้ำ, และหักยอดสุทธิชำระเงินโอน (เสร็จสมบูรณ์ 100%) |
...
| **ส่วนที่ 1: Phase 1 MVP** | 31 | 31 | 0 | 0 |
| **ส่วนที่ 2: Phase 1.5 Go-Live** | 13 | 13 | 0 | 0 |
| **ส่วนที่ 3: Phase 2 Membership** | 4 | 3 | 0 | 1 |
| **ส่วนที่ 4: Phase 3 Marketplace** | 3 | 2 | 0 | 1 |
| **รวมทั้งหมด** | **67** | **65** | **0** | **2** |

> **สรุป: ทำเสร็จแล้ว 65 รายการ (97%), ทำโครงสร้าง Mock 0 รายการ (0%), ยังไม่ได้ทำ 2 รายการ (3%)**
