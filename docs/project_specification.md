...
### 🏆 Phase 1 - Core Court Booking MVP (เฟสปัจจุบัน - เน้นระบบจอง)
เป้าหมายหลักคือเปิดระบบให้ลูกค้าสามารถเข้ามาทำการจองคิวสนามและชำระเงินแบบแมนนวลได้ทันที
*   **ระบบจองคิวสนามเทนนิสแบบระบุวันและเวลา** (Slot booking)
*   **ระบบเบอร์โทรศัพท์ SMS OTP** (เพื่อใช้ระบุและยืนยันตัวตนผู้จอง ป้องกันสแปม)
*   **ระบบส่งภาพสลิปโอนเงิน** (Payment Upload Slip - ตรวจสอบด้วยแอดมินเบื้องต้น)

### 🥈 Phase 2 - Social Matchmaking & Advanced Features (เฟสถัดไป)
เน้นการยกระดับคอมมูนิตี้และฟังก์ชันอัจฉริยะสำหรับผู้เล่น
*   **ระบบ Google OAuth (SSO)** สำหรับการสมัครสมาชิกและสร้างโปรไฟล์ผู้เล่นระดับสากล
*   **ระบบจับคู่ (Core Matching Algorithm)** คัดกรองตามเรตติ้ง NTRP (1.5 - 7.0) และสไตล์การเล่น
*   **ระบบรีวิวหลังแมตช์** (User Reviews - UGC) สำหรับความน่าเชื่อถือของผู้เล่น
*   **ระบบตรวจสอบสลิปโอนเงินอัตโนมัติ** (Auto Slip Verification via Easy Slip / SlipOK API)
